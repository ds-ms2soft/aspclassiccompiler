...
namespace Transpiler
{
	...
	{
		private readonly VB.Tree _expr;
		...
		public MvcGenerator(VB.Tree expr)
		{
			_expr = expr;
		}
		...
		public void Transpile()
		{
			...
			try
			{
				...
				//else
				{
					throw new NotImplementedException(string.Format("{0} is not yet implemented.", expr.GetType().FullName));
